<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"D:\wamp64\www\xiaomi\git\state\public/../application/index\view\index\liebiao.html";i:1599475032;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
		...
		<div class="danpin center">
			...
			<div class="main center">
				<div class="mingxing fl mb20" style="border:2px solid #fff;width:230px;cursor:pointer;" onmouseout="this.style.border='2px solid #fff'" onmousemove="this.style.border='2px solid red'">
					<div class="sub_mingxing"><a href="<?php echo url('index/head/xiangqing'); ?>" ><img src="/static/image/liebiao_xiaomi6.jpg" alt=""></a></div>
					<div class="pinpai"><a href="<?php echo url('index/head/xiangqing'); ?>" >小米6</a></div>
