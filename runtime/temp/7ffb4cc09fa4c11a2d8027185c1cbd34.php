                ...
                <ul class="nav" id="side-menu">
                    <li class="nav-header">
                        <div class="dropdown profile-element">
                            ...
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            	<!-- 修改密码 跳转到iframe框 -->
                                <li><a class="J_menuItem" href="<?php echo url('admin/login/updatePassword'); ?>">修改密码</a></li>
                    ...
                    <li>
                        <a href="<?php echo $vo['href']; ?>">
                            <span class="nav-label"><?php echo $vo['nodename']; ?></span>
                        ...
                        <ul class="nav nav-second-level">
	                        ...
	                        <li>
	                           <a class="J_menuItem" href="<?php echo $v['href']; ?>" data-index="0"><?php echo $v['nodename']; ?></a>
	                        </li>
