<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"D:\wamp64\www\xiaomi\git\state\public/../application/admin\view\login\updatepassword.html";i:1591689672;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <form class="form-horizontal m-t" id="commentForm" method="post" onsubmit="return toVaild()">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-4">
                                <input id="username" type="text" class="form-control" name="username" required="" aria-required="true" readonly="readonly" value="<?php echo $username; ?>">
                            </div>
                        </div>
                         <div class="form-group">
