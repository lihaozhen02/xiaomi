		...
		<div class="regist">
			<div class="regist_center">
				<div class="regist_top">
					...
					<div class="right fr"><a href="<?php echo url('index/index/index'); ?>" target="_self">小米商城</a></div>
					<div class="clear"></div>
				...
				<div class="regist_main center">
					...
					<div class="username">
						<div class="left fl">验&nbsp;&nbsp;证&nbsp;&nbsp;码:&nbsp;&nbsp;<input class="yanzhengma" type="text" name="vicode" id="vicode" class="vicode" placeholder="请输入验证码" maxlength="6"/></div>
						<div class="right fl"><a class="yzm" id="yzmid" onclick="send()">获取验证码</a></div>
						<div class="clear"></div>
					</div>
				</div>
